...
- **30 Comprehensive Tools** - Full debugging capability through MCP
...
| `list_execution_units` | List threads, goroutines or tasks, each carrying the kind it is |
| `get_session_output` | Read what the debugged program printed on stdout and stderr |
